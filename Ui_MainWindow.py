...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 146, 213))
        self.page_3.setObjectName("page_3")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.page_3)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_6.addItem(spacerItem)
        self.label_tell_save_anaysis_path = QtWidgets.QLabel(parent=self.page_3)
        self.label_tell_save_anaysis_path.setMinimumSize(QtCore.QSize(0, 50))
        self.label_tell_save_anaysis_path.setText("")
        self.label_tell_save_anaysis_path.setWordWrap(True)
        self.label_tell_save_anaysis_path.setObjectName("label_tell_save_anaysis_path")
        self.verticalLayout_6.addWidget(self.label_tell_save_anaysis_path)
        self.btn_setTargetReport_GenPath = QtWidgets.QPushButton(parent=self.page_3)
        self.btn_setTargetReport_GenPath.setMinimumSize(QtCore.QSize(0, 50))
        self.btn_setTargetReport_GenPath.setObjectName("btn_setTargetReport_GenPath")
        self.verticalLayout_6.addWidget(self.btn_setTargetReport_GenPath)
        self.btn_uploadReport = QtWidgets.QPushButton(parent=self.page_3)
        self.btn_uploadReport.setMinimumSize(QtCore.QSize(0, 50))
        self.btn_uploadReport.setObjectName("btn_uploadReport")
        self.verticalLayout_6.addWidget(self.btn_uploadReport)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_6.addItem(spacerItem1)
        self.label_image_show = QtWidgets.QLabel(parent=self.page_3)
        self.label_image_show.setText("")
        self.label_image_show.setScaledContents(True)
        self.label_image_show.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_image_show.setObjectName("label_image_show")
        self.verticalLayout_6.addWidget(self.label_image_show)
        self.operatorBox.addItem(self.page_3, "")
        self.recognize_page = QtWidgets.QWidget()
        self.recognize_page.setGeometry(QtCore.QRect(0, 0, 182, 462))
        ...
        self.label_inform_report_path = QtWidgets.QLabel(parent=self.recognize_page)
        self.label_inform_report_path.setMinimumSize(QtCore.QSize(0, 50))
        self.label_inform_report_path.setText("")
        self.label_inform_report_path.setWordWrap(True)
        self.label_inform_report_path.setObjectName("label_inform_report_path")
        self.verticalLayout_2.addWidget(self.label_inform_report_path)
        self.btn_set_report_gen_path = QtWidgets.QPushButton(parent=self.recognize_page)
        self.btn_set_report_gen_path.setMinimumSize(QtCore.QSize(0, 50))
        self.btn_set_report_gen_path.setObjectName("btn_set_report_gen_path")
        self.verticalLayout_2.addWidget(self.btn_set_report_gen_path)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 116, 142))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 98, 111))
        ...
        self.OCR_Result_Recognizer = QtWidgets.QTableWidget(parent=self.page_2)
        self.OCR_Result_Recognizer.setObjectName("OCR_Result_Recognizer")
        self.OCR_Result_Recognizer.setColumnCount(0)
        self.OCR_Result_Recognizer.setRowCount(0)
        self.verticalLayout_5.addWidget(self.OCR_Result_Recognizer)
        self.operatorBox.addItem(self.page_2, "")
        ...
        self.action_set_report_gen_path = QtGui.QAction(parent=MainWindow)
        self.action_set_report_gen_path.setObjectName("action_set_report_gen_path")
        self.action_start_gen_report_analysis = QtGui.QAction(parent=MainWindow)
        self.action_start_gen_report_analysis.setObjectName("action_start_gen_report_analysis")
        ...
        self.menu_2.addAction(self.action_set_report_gen_path)
        self.menu_2.addAction(self.action_start_gen_report_analysis)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_setTargetReport_GenPath.setText(_translate("MainWindow", "设置解析报告导出路径"))
        self.btn_uploadReport.setText(_translate("MainWindow", "报告图象上传"))
        self.operatorBox.setItemText(self.operatorBox.indexOf(self.page_3), _translate("MainWindow", "解析报告"))
        self.btn_set_report_gen_path.setText(_translate("MainWindow", "设置报告生成地址"))
        self.btn_start_recognize.setText(_translate("MainWindow", "开始识别"))
        self.operatorBox.setItemText(self.operatorBox.indexOf(self.recognize_page), _translate("MainWindow", "生成报告"))
        ...
        self.label.setText(_translate("MainWindow", "识别参数结果"))
        self.operatorBox.setItemText(self.operatorBox.indexOf(self.page_2), _translate("MainWindow", "图像识别"))
        ...
        self.action_set_report_gen_path.setText(_translate("MainWindow", "设置报告导出文件夹路径"))
        self.action_start_gen_report_analysis.setText(_translate("MainWindow", "分析报告"))
