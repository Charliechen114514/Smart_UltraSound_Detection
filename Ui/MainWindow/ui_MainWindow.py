...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page.setGeometry(QRect(0, 0, 183, 468))
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/pagetables/pagetables/preload.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.operate_tool_box.addItem(self.page, icon10, u"\u524d\u7f6e\u52a0\u8f7d")
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.page_2.setGeometry(QRect(0, 0, 183, 468))
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/pagetables/pagetables/settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_set_analysis_path.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/pagetables/pagetables/analysis_report.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_analysis_report.setIcon(icon12)
        ...
        self.operate_tool_box.addItem(self.page_2, icon12, u"\u89e3\u6790\u7aef\u5c0f\u7a0b\u5e8f")
        self.page_3 = QWidget()
        self.page_3.setObjectName(u"page_3")
        self.page_3.setGeometry(QRect(0, 0, 190, 456))
        ...
        self.btn_set_summon_path.setIcon(icon11)
        ...
        self.page_4.setGeometry(QRect(0, 0, 88, 52))
        ...
        self.label_param = QLabel(self.widget_param_browsing)
        self.label_param.setObjectName(u"label_param")

        self.verticalLayout_3.addWidget(self.label_param)
        ...
        self.operate_tool_box.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_param.setText(QCoreApplication.translate("MainWindow", u"\u53c2\u6570\u8bf4\u660e", None))
